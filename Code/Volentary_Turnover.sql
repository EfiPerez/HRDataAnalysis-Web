...
(
			...
			(
				...
				FROM HRDataset_v9
				WHERE [Employment Status] NOT IN ('Active','Future start', 'Leave of Absence','Terminated for Cause')-- Notice that there are 2 employees that has termination date but still active, this is why there is a difference for comparison to excel file
